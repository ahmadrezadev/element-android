...
# Artifact URL
echo
read -p "Artifact url (ex: https://github.com/mana-hq/mana-android/suites/9293388174/artifacts/435942121)? " artifactUrl

## Example of default value for Gplay
#artifactUrl=${artifactUrl:-https://github.com/mana-hq/mana-android/suites/9293388174/artifacts/435942121}
## Example of default value for FDroid
# artifactUrl=${artifactUrl:-https://github.com/mana-hq/mana-android/suites/9293388174/artifacts/435942119}
